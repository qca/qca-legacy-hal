 ...
 * Copyright (c) 2005-2008 Atheros Communications, Inc.
 *
 ...
 * any supplied country code.  We also do a lot of EEPROM
 * verification
 */
...
#define CHANNEL_QUARTER_BW	5
	...
	if (!isCountryCodeValid(ah, cc)) {
		/* We ignore invalid country codes */
	...
	for (cm = modes; cm < &modes[N(modes)]; cm++) {
		...
		/*
		 * Keep a private copy of the channel list
		 */
