...
ath_hal_factory_defaults(struct ath_hal_private *ap, struct hal_reg_parm *hal_conf_parm)
{
    ...
    ap->ah_config.ath_hal_analogShiftReg            = 1;  /* enable analog shift reg by default */
    ...
    ap->ah_config.ath_hal_enableANI                 = 0;
    ...
    ap->ah_config.ath_hal_intrMitigation            = 0;
#else
    ap->ah_config.ath_hal_intrMitigation            = 1;
#endif
#endif
